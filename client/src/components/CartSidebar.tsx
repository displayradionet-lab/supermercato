...
import { ArrowRightIcon, MinusIcon, PlusIcon, ShoppingBagIcon, ShoppingCartIcon, Trash2Icon, XIcon } from "lucide-react";
                ...
                <div key={item.product.id} className="flex gap-3 bg-app-cream/60 rounded-xl p-3">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-app-text-light">
                            {item.product.price.toFixed(2)} / {item.product.unit}</p>
                            <div className="flex items-center justify-between mt-2">
                               ...
                               <span className="text-sm font-semibold">
                                {currency} {(item.product.price * item.quantity).toFixed(2)}</span>
       ...
       {items.length > 0 && (
        <div className="p-5 border-t border-app-border space-y-3">
            <div className="flex justify-between text-sm">
                <span className="text-app-text-light">Sub-totale</span>
            ...
            {deliveryFee > 0 && <p className="text-sm text-app-text-light text-center">
                Spedizione gratuita per ordini oltre i 20 euro</p>}
