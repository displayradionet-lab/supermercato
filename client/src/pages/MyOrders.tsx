...
const MyOrders = () => {  
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      // Salvataggio sicuro controllando le varie strutture possibili di risposta
  ...
  // Ricarica correttamente i dati ogni volta che l'utente cambia tab
  ...
  return (
    <div className="min-h-screen bg-app-cream mb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-2xl font-semibold text-app-green mb-6">Ordini</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h2 className="text-lg font-medium text-app-green mb-2">Nessun ordine ancora</h2>
            <p className="text-sm text-app-text-light mb-4">Compra ora per vedere i tuoi ordini qui</p>
